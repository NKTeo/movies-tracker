...
export default class EditMovie extends Component {
    ...
    // Get existing data of movie
    componentDidMount() {
        let path = window.location.href
        let id = path.split("/").at(-1);
        console.log(id);
        axios.get('https://movie-tracker-nk.herokuapp.com/movie/' + id)
            .then(response => {
    ...
    onSubmit(e) {
        ...
        let path = window.location.href
        let id = path.split("/").at(-1);
        axios.put('https://movie-tracker-nk.herokuapp.com/movie/' + id, movie)
